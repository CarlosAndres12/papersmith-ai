...
const source = await readFile('skills/proposal-deliberation/engine/proposal-workspace.ts', 'utf8');
const intents = await readFile('skills/proposal-deliberation/engine/types.ts', 'utf8');
