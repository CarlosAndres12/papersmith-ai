...
const PROFILE=path.resolve('skills/proposal-deliberation/profile.ts');
...
test('no document tells a reader to run the bare core',async()=>{
	...
	const docs=['skills/proposal-deliberation/SKILL.md','skills/proposal-deliberation/references/usage.md','skills/proposal-implementation/SKILL.md','skills/proposal-implementation/references/usage.md','README.md'];
