...
const {createJiti}=await import('jiti'); const jiti=createJiti(import.meta.url); const workspaceModule=await jiti.import(path.resolve('skills/proposal-deliberation/engine/proposal-workspace.ts')); const v2=await jiti.import(path.resolve('skills/proposal-deliberation/engine/exports.ts'));
