...
- Use only `node skills/proposal-deliberation/engine/cli.mjs` for execution. Do not modify engine infrastructure, tests, or this skill during normal proposal work.
